...
const submit = async () => {
    ...
    try {
        ...
        successMessage.value = data.message || 'Password reset link sent to your email.';
        form.value.email = '';
    } catch {
            ...
            >
                ...
                <form @submit.prevent="submit" class="px-8 pb-8 space-y-6">
                    ...
                    <button
                        type="button"
                        @click="goBack"
                        class="w-full flex items-center justify-center gap-2 py-3 text-gray-400 hover:text-white transition-colors duration-200"
                    >
