...
import { Lock, Mail, AlertCircle, User, Phone } from 'lucide-vue-next';
        ...
        <div class="relative w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div class="px-8 pt-8 pb-6 text-center bg-gradient-to-r from-emerald-500 to-teal-500">
                    ...
                    <p class="text-emerald-100 text-sm">Join us today</p>
                </div>

                <!-- Form -->
                <form @submit.prevent="submit" class="px-8 py-8 space-y-5">
                    <!-- General Error -->
                    ...
                    <!-- Name Field -->
                    <div>
                        <InputLabel for="name" value="Full Name" class="text-gray-700 mb-2" />
                        <div class="relative">
                    ...
                    <!-- Phone Field -->
                    <div>
                        <InputLabel for="phone" value="Phone (Optional)" class="text-gray-700 mb-2" />
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    ...
                    <div>
                        <InputLabel for="password_confirmation" value="Confirm Password" class="text-gray-700 mb-2" />
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <Lock class="w-5 h-5 text-gray-400" />
                            </div>
                    ...
                    <p class="text-center text-gray-600 text-sm">
                        ...
                        <router-link :to="{ name: 'customer.login' }" class="text-emerald-600 hover:text-emerald-700 font-medium">
                            Sign in
                        </router-link>
                    </p>
                </form>
